...
using SendGrid;
using Auto.IdentityServer4Admin.Shared.Configuration.Email;
using Auto.IdentityServer4Admin.Shared.Email;
using Auto.IdentityServer4Admin.STS.Identity.Configuration;
using Auto.IdentityServer4Admin.STS.Identity.Configuration.ApplicationParts;
using Auto.IdentityServer4Admin.STS.Identity.Configuration.Constants;
using Auto.IdentityServer4Admin.STS.Identity.Configuration.Interfaces;
using Auto.IdentityServer4Admin.STS.Identity.Helpers.Localization;
using System.Linq;
using Skoruba.IdentityServer4.Admin.EntityFramework.Interfaces;
using Auto.IdentityServer4Admin.Admin.EntityFramework.MySql.Extensions;
using Auto.IdentityServer4Admin.Admin.EntityFramework.PostgreSQL.Extensions;
using Auto.IdentityServer4Admin.Admin.EntityFramework.Shared.Configuration;
using Auto.IdentityServer4Admin.Admin.EntityFramework.SqlServer.Extensions;
using Skoruba.IdentityServer4.Admin.EntityFramework.Helpers;
using Microsoft.AspNetCore.DataProtection.EntityFrameworkCore;
using Microsoft.AspNetCore.Http;
using Auto.IdentityServer4Admin.Shared.Authentication;
using Auto.IdentityServer4Admin.Shared.Configuration.Identity;

namespace Auto.IdentityServer4Admin.STS.Identity.Helpers
{
