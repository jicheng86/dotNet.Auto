...
using Auto.IdentityServer4Admin.STS.Identity.ViewModels.Manage;

namespace Auto.IdentityServer4Admin.STS.Identity.Controllers
{    
    [Authorize]
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        private string GenerateQrCodeUri(string email, string unformattedKey)
        {
            return string.Format(
                ...
                _urlEncoder.Encode("Auto.IdentityServer4Admin.STS.Identity"),
