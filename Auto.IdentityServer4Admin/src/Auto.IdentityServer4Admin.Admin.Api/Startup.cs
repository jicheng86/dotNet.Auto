...
using Auto.IdentityServer4Admin.Admin.Api.Configuration.Authorization;
using Auto.IdentityServer4Admin.Admin.Api.ExceptionHandling;
using Auto.IdentityServer4Admin.Admin.Api.Helpers;
using Auto.IdentityServer4Admin.Admin.Api.Mappers;
using Auto.IdentityServer4Admin.Admin.Api.Resources;
using Auto.IdentityServer4Admin.Admin.EntityFramework.Shared.DbContexts;
using Auto.IdentityServer4Admin.Admin.EntityFramework.Shared.Entities.Identity;
using Auto.IdentityServer4Admin.Shared.Dtos;
using Auto.IdentityServer4Admin.Shared.Dtos.Identity;
using Auto.IdentityServer4Admin.Shared.Helpers;

namespace Auto.IdentityServer4Admin.Admin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDataProtection()
                .SetApplicationName("Auto.IdentityServer4Admin")
